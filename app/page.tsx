      ...
      <header className="bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-[1400px] mx-auto px-6 py-4 flex items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-3 text-sm shrink-0">
            ...
            <button type="button"
              onClick={() => window.open('https://tools.getva365.com/wordpresssite.html', '_blank', 'noopener,noreferrer')}
              className="border border-green-600 text-green-700 px-3 py-1.5 rounded-lg font-medium hover:bg-green-50 transition-colors">
              Property Sites Status
            </button>
