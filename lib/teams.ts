...
export const TEAMS: Team[] = [
  {
    name: "Sunshine",
    title: "TEAM SUNSHINE",
    properties: ["Creativetain", "BringTheStreams", "BringTheStream", "Buckstreams", "Streamsdepot", "Axentv", "PhoxStreams", "Gyrostreams", "Dipiptv", "PrimoChannel", "Firestreams", "Speedygo"],
  },
  {
    name: "PY/FMB",
    title: "TEAM PYROFBM",
